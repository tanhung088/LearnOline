...
<html>
    ...
    <body>
        <h1>Create Form Product</h1>
        <c:if test="${not empty errors}">
            <c:forEach items="${errors}" var="error">
                <c:if test="${error.key == 'price'}">
                    <div class="alert alert-warning">
                        <strong><c:out value="${error.value}" /></strong>
                    </div>
                </c:if>
            </c:forEach>
        </c:if>
        ...
        <form action="products?action=create" method="post" enctype="multipart/form-data" class="align-items-center">
            <div class="col-12">
