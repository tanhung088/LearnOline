...
<html>
    ...
    <body>
        <h1>Edit Form</h1>
        <form action="phones?action=edit" method="post" enctype="multipart/form-data" class="align-items-center">
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" value="${data.getName()}" class="form-control" name="name" id="name" />
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="col-12">
